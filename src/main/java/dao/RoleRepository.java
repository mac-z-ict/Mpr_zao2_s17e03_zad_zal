...
public class RoleRepository extends RepositoryBase<Role> implements IRoleRepository {
	//nazwa tabeli
	public static final String TABLE_NAME = "t_sys_roles";
	//zapytania
	...
	private static final String BY_USER_QUERY = "SELECT R.* FROM "+TABLE_NAME+" R INNER JOIN UserRoles UR ON (R.id = UR.roleId) "
			+ "WHERE UR.userId = ?";
